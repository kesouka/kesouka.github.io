            ...
            s = function (t) {
                ...
                return i.__extends(e, t), e.prototype.updateDayTable = function () {
                    ...
                    var n = this,
                        ...
                        o = n.getDayClasses(t);
                    return o.unshift("fc-day", i.calendar.theme.getClass("widgetContent")), '<td class="' + o.join(" ") + '"' + (r ? ' id="' + t.format("YYYY-MM-DD") + '"' : "") + (e ? " " + e : "") + "></td>"
        ...
        var i = n(2),
            ...
            m = function (t) {
                ...
                return i.__extends(e, t), e.prototype.componentFootprintToSegs = function (t) {
                    ...
                    return s || this.cellWeekNumbersVisible ? (e = this.getDayClasses(t), e.unshift("fc-day-top"), this.cellWeekNumbersVisible && (n = "ISO" === t._locale._fullCalendar_weekCalc ? 1 : t._locale.firstDayOfWeek()), r += '<td class="' + e.join(" ") + '"' + (o ? ' id="' + t.format() + '"' : "") + ">", this.cellWeekNumbersVisible && t.day() === n && (r += i.buildGotoAnchorHtml({
                        date: t,
                        type: "week"
                    }, {
        ...
        var i = n(2),
            ...
            c = function (t) {
                ...
                return i.__extends(e, t), e.prototype.renderSkeleton = function () {
                    ...
                    return '<tr class="fc-list-heading" id="' + t.format("YYYY-MM-DD") + '"><td class="' + (this.calendar.theme.getClass("tableListHeading") || this.calendar.theme.getClass("widgetHeader")) + '" colspan="3">' + (e ? this.buildGotoAnchorHtml(t, {
